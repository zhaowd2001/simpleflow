<%@ Page Title="" Language="C#" MasterPageFile="~/Skeleton.master" AutoEventWireup="true"
    CodeFile="AtMe.aspx.cs" Inherits="AtMe" %>
                        ...
                        <div class="userNameStyle">
                            ...
                            <div class="followStyle">
                                <div class="followBoxStyle">
                                    <b>
                                        <%# Eval("User.ScreenName")%></b> (<%# Eval("User.Location")%>)
                                    <div style="margin-bottom: 4px">
                                        Fans:<b><%# Eval("User.FollowersCount")%></b>&nbsp;Friends:<b><%# Eval("User.FriendsCount")%></b>&nbsp;Statuses:<b><%# Eval("User.StatusesCount")%></b></div>
                                    <div class="userDescStyle">
                                        <%# Eval("User.Description")%></div>
                                    <div style="position: absolute; bottom: 4px; left: 4px;">
                                        <span style="display: <%# Eval("DisplayUserFollow")%>">
                                            <asp:LinkButton ID="LinkButton2" runat="server" Text="Follow" CommandArgument='<%# Eval("User.ID")%>'
                                                OnClick="HandleFollow" />
                                        </span><span style="display: <%# Eval("DisplayUserUnfollow")%>">
                                            <asp:LinkButton ID="LinkButton3" runat="server" Text="Unfollow" CommandArgument='<%# Eval("User.ID")%>'
